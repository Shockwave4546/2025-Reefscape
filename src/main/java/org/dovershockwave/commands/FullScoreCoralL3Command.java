...
public class FullScoreCoralL3Command extends SequentialCommandGroup {
  public FullScoreCoralL3Command(SwerveSubsystem swerve, VisionSubsystem vision, CoralPivotSubsystem coralPivot, CoralRollersSubsystem coralRollers, ElevatorSubsystem elevator, ReefScoringSelector selector) {
    addCommands(
            new InstantCommand(() -> selector.setLevel(ReefScoringPosition.ReefLevel.L3)),
