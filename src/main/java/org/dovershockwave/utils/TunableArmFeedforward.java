...
public class TunableArmFeedforward {
  ...
  public TunableArmFeedforward(String prefix, ArmFeedforwardConstants constants) {
  ...
  public void periodic(Consumer<ArmFeedforwardConstants> armFeedforwardConfigurator, Consumer<Double> manualValueSetter) {
    TunableNumber.ifChanged(hashCode(), values -> armFeedforwardConfigurator.accept(
  ...
  public void setConstants(ArmFeedforwardConstants constants) {
    kS.set(constants.kS());
    kG.set(constants.kG());
    kV.set(constants.kV());
    kA.set(constants.kA());
  ...
  public ArmFeedforwardConstants getConstants() {
