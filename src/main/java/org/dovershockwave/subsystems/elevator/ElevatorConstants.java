...
public class ElevatorConstants {
  ...
  public static final ElevatorFeedforwardConstants FEEDFORWARD_GAINS = new ElevatorFeedforwardConstants(0.0, 0.0, 0.0, 0.0, new TrapezoidProfile.Constraints(0.0, 0.0));
