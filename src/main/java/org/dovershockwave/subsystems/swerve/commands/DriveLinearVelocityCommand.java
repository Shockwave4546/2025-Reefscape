...
public class DriveLinearVelocityCommand extends Command {
  ...
  private final HeadingController headingController = new HeadingController("DriveLinearVelocityCommand", Units.degreesToRadians(2), VisionConstants.ALIGNMENT_OMEGA_PID);
