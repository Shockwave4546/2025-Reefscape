...
public class DriveAngularVelocityCommand extends Command {
  public static final TunableNumber rotationRad = new TunableNumber("DriveAngularVelocityCommand/RotationRad", 3.5);
  public static final TunableNumber velocity = new TunableNumber("DriveAngularVelocityCommand/OmegaRadPerSec", 2.0);
  ...
  @Override public boolean isFinished() {
    return Math.abs(swerve.getPose().getRotation().getRadians()) >= rotationRad.get() || controller.rightTrigger().getAsBoolean();
  }
}