...
//  public static final CoralPivotState STARTING = new CoralPivotState(2.643, 2.05);
  ...
  public static final CoralPivotState HUMAN_PLAYER = new CoralPivotState(2, -1.2);
  public static final CoralPivotState L1 = new CoralPivotState(1.932, -1.0907);
  ...
  public static final CoralPivotState ALGAE_KNOCK_OFF_L3 = new CoralPivotState(-0.35, 0.35);
}